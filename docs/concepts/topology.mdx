---
title: "Topology"
description: "How an NTL network self-organises: peers are discovered rather than configured, and the routing graph emerges from which paths actually deliver."
