...
description: "A new concurrency primitive: not a simulation of a neural network but an actual one, where the signal replaces the request as the base unit."
mode: "wide"
...
_Signal Primitive Design — April 2026 — The Bundu Foundation_

_"Not a simulation of a neural network. It IS a neural network."_
