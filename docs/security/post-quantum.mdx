...
This doesn't mean quantum computers will break _everything_ — symmetric encryption (AES) and hash functions (SHA-3, BLAKE3) remain quantum-resistant with sufficient key sizes.
...
The key insight: by treating crypto as pluggable, NTL doesn't need to predict _which_ PQ scheme will win long-term. It just needs to be able to swap.
